...
$("#export-model").click(function () {
    let modelData = {
        ...
        info: JSON.parse(
            localStorage.getItem("tensorflowjs_models/pospine/info")
        ),
        weight_specs: JSON.parse(
            localStorage.getItem("tensorflowjs_models/pospine/weight_specs")
        ),
        weight_data: localStorage.getItem(
            "tensorflowjs_models/pospine/weight_data"
        ),
    };
